...
<h2>User Post</h2>
	<div class="row">
		<div class="col-4">
			<img src="${post.postphotoURL}" height="200" width="200" />
		</div>
		<div class="col-8">
			<h3>${post.text}</h3>
		</div>
        <div class="col-4">
		<form id="commentForm" action="/savecomment" method="post">
			<div class="form-group">
					<label>Add Comments:</label>
						<textarea class="form-control" id="textarea" rows="2"
							name="textarea" required></textarea>
						<input type="hidden" name="postId">
						<button name="Send" class="btn btn-primary" value="Send"
							onclick="sendid('${post.postId}')" />
						Send
